...
<body>
    ...
    <div class="flex">
        ...
        <form action="GerenciarMenu" method="post">
            ...
            <p>Nome: <input type="text" name="nome" title="Apenas caracters alfabéticos!" required></p>
            <p>Link:<input type="text" name="link" placeholder="pagina.jsp" title="Apenas caracters alfabéticos minusculos!"  required></p>
            <p>Imagem:<input type="file" name = "imagem"></p>
            <input type="submit" value="Cadastrar Menu">
        </form>
    </div>
</body>
</html>
