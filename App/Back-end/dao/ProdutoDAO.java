...
public class ProdutoDAO {
    ...
    public List<Produto> listar() {
        ...
        try {
            ...
            while (rset.next()) {
                ...
                produto.setPreco(rset.getDouble("prceo"));
    ...
    public boolean alterar(Produto produto) {
        String sql = "UPDATE produto SET codigo = ?, descricao = ?, nome = ? quantidade = ?, quantidadeCritica = ?, imagem = ?, fornecedor = ?, preco = ?, custo = ?, status = ? WHERE id = ?";
