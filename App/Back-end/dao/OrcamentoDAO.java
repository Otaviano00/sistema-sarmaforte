...
public class OrcamentoDAO {
    ...
    public static boolean registrar(Orcamento orcamento) {
        ...
        try {
            ...
            pstm.setDate(1, Date.valueOf(orcamento.getDataCriacao()));
            pstm.setDate(2, Date.valueOf(orcamento.getDataValidade()));
        ...
        try {
            ...
            while (rset.next()) {
                ...
                try {
                    ...
                    Date sqlCriacao = rset.getDate("o.dataCriacao");
                    Date sqlValidade = rset.getDate("o.dataValidade");
                    ...
                    orcamento.setDataCriacao(sqlCriacao.toLocalDate());
                    orcamento.setDataValidade(sqlValidade.toLocalDate());
    ...
    public static List<ItemOrcamento> listarItem(int idOrcamento) {
        ...
        String sql = ""
                ...
                + " FROM"
                + " produto p INNER JOIN item_orcamento i ON p.id = i.id_produto"
                + " WHERE"
                + " i.id_orcamento = ?";

        List<ItemOrcamento> items = new ArrayList<ItemOrcamento>();
