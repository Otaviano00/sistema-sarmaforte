    ...
    <div class="flex">
        ...
        <form action="GerenciarCliente" method="post">
            ...
            <div class="campos">
                ...
                <input type="text" name="nome" title="Apenas caracteres alfabéticos!" value="<%= cliente.getNome() %>" required>
            </div>
            ...
            <div class="campos">
                ...
                <input type="text" name="telefone" title="Apenas caracteres numéricos!" value="<%= cliente.getTelefone() %>" required>
            </div>
            
            <div class="campos">
                <label for="cpf" class="titulo_campo">CPF:</label>
                <input type="text" name="cpf" value="<%= cliente.getCpf() == null? "" : cliente.getCpf()%>">
            </div>

            <div class="campos">
                <label for="endereco" class="titulo_campo">Endereço:</label>
                <input type="text" name="endereco" value="<%= cliente.getEndereco() == null? "" : cliente.getEndereco() %>">
            </div>
