    ...
    <div class="flex">
        ...
        <form>
            <div class="campos">
                ...
                <input type="text" name="nome" value="<%= produto.getNome() %>" disabled readonly>
            </div>

            <div class="campos">
                <label for="descricao" class="titulo_campo">Descrição:</label>
                <textarea name="descricao" rows="3" cols="30" readonly disabled><%= produto.getDescricao() %></textarea>
            </div>

            <div class="campos">
                <label for="quantidade" class="titulo_campo">Quantidade:</label>
                <input type="number" name="quantidade" min="0" value="<%= produto.getQuantidade() %>" disabled readonly>
            </div>

            <div class="campos">
                <label for="quantidadeCritica" class="titulo_campo">Quantidade Crítica:</label>
                <input type="number" name="quantidadeCritica" min="0" value="<%= produto.getQuantidadeCritica() %>" readonly disabled>
            </div>
            ...
            <div class="campos">
                ...
                <input type="text" name="fornecedor" value="<%= produto.getFornecedor() %>" readonly disabled>
            </div>
            ...
            <div class="campos" style="gap: 5px;">
                ...
                <div style="display: flex; justify-content: start; align-items: start; gap: 10px;">
                    <label for="ativo"  class="botao_radio">Ativo
                        <input type="radio" name="status" id="ativo" value="1" <%= produto.isStatus()? "checked" : " "%> readonly disabled >
                    </label>
                    <label for="desativo" class="botao_radio">Desativo
                        <input type="radio" name="status" id="desativo" value="0" <%= !produto.isStatus()? "checked" : " "%> readonly disabled>
                    </label>
                </div>
            </div>
