...
<html lang="en">
    ...
    %>
    <a href="imprimir_orcamento.jsp"></a>
    <head>
        <meta charset="UTF-8">
        ...
        <script defer src="script/imprimir.js"> </script>
                ...
                <form id="dados_cliente" style="margin-top: -30px;">
                    ...
                    <div style="display: flex; flex-direction: row; justify-content: space-around; min-width: 100%">
                        ...
                        <div class="campo_cliente campos">
                            ...
                            <input type="text" value="<%= orcamento.getCliente().getTelefone() != null? orcamento.getCliente().getTelefone() : "---"%>" disabled readonly>
                        </div>
                        <div class="campo_cliente campos">
                            <label>CPF:</label>
