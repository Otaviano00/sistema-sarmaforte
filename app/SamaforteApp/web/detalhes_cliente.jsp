    ...
    <div class="flex">
        ...
        <form action="#" method="post">
            ...
            <div class="campos">
                ...
                <input type="text" name="cpf" maxlength="11" value="<%= cliente.getCpf() == null? "" : cliente.getCpf()%>"  disabled readonly>
            </div>

            <div class="campos">
                <label for="endereco" class="titulo_campo">Endereço:</label>
                <input type="text" name="endereco" value="<%= cliente.getEndereco() == null? "" : cliente.getEndereco()%>" disabled readonly>
            </div>
